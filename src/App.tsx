...
const JOBS_CARDS: JobsPropsType[] = [
  {  id: v1(),
    ...
    background: todoImg,
    title: "Todolist",
    description: "It looks like an ordinary Todolist, but this is only at first glance, if you open the code, you can see all the most modern approaches to developing web applications using the React and Redux libraries.",
  ...
  {  id: v1(),
    ...
    title: "Counter",
    description: "Сounter written in React and Redux libraries.",
  ...
  {  id: v1(),
    ...
    description: "The project uses architectural solutions for easy scaling of the application. Written in React and Redux libraries, Rest API is used for data exchange.",
